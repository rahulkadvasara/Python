...
#         minCriticalDistance = float("inf")
#         maxCriticalDistance = float("-inf")
...
#                 if lastCritical != -1 and i - lastCritical < minCriticalDistance:
#                     minCriticalDistance = i - lastCritical

#                 lastCritical = i

#                 if firstCritical != -1:
#                     maxCriticalDistance = i - firstCritical
#                 else:
#                     firstCritical = i
...
#         return [minCriticalDistance, maxCriticalDistance]